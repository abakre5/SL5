...
class RoomBookingClient
{
	...
	public static void main (String[] args)
	{
		try
		{
			Registry Naming = LocateRegistry.getRegistry ("localhost", 9876);
			RoomBookingInterface rbi=(RoomBookingInterface)Naming.lookup("RoomBookingSystem");
			...
			while( validChoice != false )
			{
				...
				try{
					...
					for(int c = 0; c < 10; c++)        //Print the list.
					{
