...
class RoomBookingServer extends UnicastRemoteObject implements RoomBookingInterface
{
	...
	public String RoomListTemp [] = new String [10];       //Temporary store for list of rooms
	public String temp = new String();
	public Room RoomArray[] = new Room[10];                  //Array of Room Objects
	...
	public static void main (String[] args)
	{
		try
		{
			...
			java.rmi.registry.LocateRegistry.createRegistry(9876).rebind("RoomBookingSystem", server);
			System.out.println ("RoomBookingSystem is running");
		}
		catch (Exception ex)
		{
